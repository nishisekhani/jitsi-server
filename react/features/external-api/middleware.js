        ...
        case SET_LOADABLE_AVATAR_URL: {
            ...
            if (participant) {
                if (loadableAvatarUrl) {
                    participant.loadableAvatarUrl !== loadableAvatarUrl &&
                        APP.API.notifyAvatarChanged(id, loadableAvatarUrl);
                } else {
    ...
    switch (action.type) {
        ...
        case KICKED_OUT:
            APP.API.notifyKickedOut(
                ...
                {
                    id: action.participant
                        ? action.participant.getId()
                        : undefined,
                }
            );
            break;
